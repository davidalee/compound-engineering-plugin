---
name: ce-code-review-beta
description: "[BETA] Structured code review with experimental Codex delegation for mid-tier reviewer personas. Same as ce-code-review but routes delegatable reviewers to Codex CLI to conserve tokens."
disable-model-invocation: true
argument-hint: "[blank to review current branch, or provide PR link] [delegate:codex]"
---
...
| `delegate:codex` | `delegate:codex` | Activate Codex delegation for mid-tier persona reviewers |
...
### Codex Delegation Workflow (beta)
